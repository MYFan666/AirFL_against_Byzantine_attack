...
from utils.options80 import args_parser
from models.Update import LocalUpdate
from models.Nets import MLP, CNNMnist, CNNCifar, CNNCifarRes, CNNCifarRes18
from utils.averagingProposed import quan_average_gradients_Imperfect_CSI, quan_average_gradients_AWGN, \
...
fh = logging.FileHandler('80_Fading_Proposed_0.25_{:.4f}.log'.format(time.time()))
