...
def args_parser():
    ...
    parser.add_argument('--num_users', type=int, default=70, help="number of users: K")
    ...
    # quan
    parser.add_argument('--mode', type=str, default='P_CSI', help="Tx mode")
    # snr
    ...
    # g_th
    parser.add_argument('--thd', type=float, default=1, help="THD")
    # Byzantine attackers
    parser.add_argument('--bzt', type=int, default=0.2, help='number of Byzantine attackers')
