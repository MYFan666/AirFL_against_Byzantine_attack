...
from utils.averagingSignSGD import quan_average_gradients_Imperfect_CSI, quan_average_gradients_AWGN, \
...
fh = logging.FileHandler('30_Fading_SignSGD_0.25_{:.4f}.log'.format(time.time()))
